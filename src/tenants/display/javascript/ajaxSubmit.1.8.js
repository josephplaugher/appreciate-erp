$(document).ready(function() { 
    ...
    rules: { 
        ...
        ignore: ":hidden",
            ...
            //account settings
                    ...
                    email: {required: true, email: true}, // Specify that email should be validated by the built-in "email" rule 
    ...
    messages: { 
            //account settings
                    ...
                    email: {required: "Email required", email: "Please enter a valid email address"}, 
            ...
            //person and address rules		
                    ...
                    state: {required: "Please use a two character state"}, 	
            ...
            //banking section
                    stmtenddate: {required: "Statement end date required", date: "yyy/mm/dd"},
                    stmtendbal: {required: "Statement end balance required", number:"Dollars and cents only"},
                    //accounts section	
            //general
                    comments: {required: "No special characters, please"}
    }, 
...
if($("form[name='ajaxform']").valid()) {
 ...
 if(formid === 'Bank_Ledger' || formid === 'Bank_Reconciliation'){
   var dt = 'html';
   }else{
   var dt = 'json';
   }
 $.ajax({
        cache   : false,
        url     : $("form[name='ajaxform']").attr('action'),
        type    : 'post',
        dataType: dt,
