...
class formelements {
    ...
    public  function beginForm($title,$action,$userform = NULL) {
        if($userform == 'userform') {$url = '../model/usercont.php?'.$action;
        }else{$url = '../model/sscont.php?'.$action;}
    ...
    public  function newUserForm($title,$action) {
        switch($action) {
            case 'login':
    ...
    public  function paymentInput($label) {
        ...
        switch($label) {
            case 'Card Number':
                $outputVal = '<div class = "label"><p1>'.$label.'</p1></div><div class = "field">'
                        . '<input class = "textinput" type="input" id="card-number" maxlength = "16"></div>';
                break;
            
            case 'CVC': 
                $outputVal = '<div class = "label"><p1>'.$label.'</p1></div><div class = "field">'
                        . '<input class = "CVC" type="input" id="card-cvc" maxlength = "4"></div>';
                break;
            
            case 'Expiration (YYYY/MM)': 
                $outputVal = '<div class = "label"><p1>'.$label.'</p1></div>'
                    . '<div class = "field"><input class = "Exp_year" type="input" id="card-expiry-year" maxlength = "7">'
                    . '<input class = "Exp_month" type="input" id="card-expiry-month" maxlength = "2"></div>';
                break;
    ...
    public function multipleSelect($label,$id) {//this is designed to be populated by javascript
        return '<div class = "label"><p1>'.$label.'</p1></div><div class = "field"><input class="textinput" name="'.$id.'" id="'.$id.'"></div><div class = "multipleSelectDiv" id="multipleDiv"><select class = "multipleSelect" multiple></select></div>';
           }
