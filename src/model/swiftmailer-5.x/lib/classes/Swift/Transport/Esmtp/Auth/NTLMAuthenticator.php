...
.$lmResponse
    ...
    protected function debug($message)
    {
        ...
        print substr($message, 0, 16)." NTLMSSP Signature<br />\n";
        print $messageId." Type Indicator<br />\n";
        ...
        if ($messageId == '02000000') {
            ...
            foreach ($map as $key => $value) {
                print bin2hex($data[$key]).' - '.$data[$key].' ||| '.$value."<br />\n";
            }
            ...
            foreach ($map as $key => $value) {
                print $data[$key].' - '.$this->hex2bin($data[$key]).' ||| '.$value."<br />\n";
            }
        }
